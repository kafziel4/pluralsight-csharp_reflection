...
static void CodeFromThirdModule()
{
    ...
    var person3 = personConstructors[2].Invoke(new object[] { "Kevin", 32 });
    ...
    var privateFiled = personForManipulation?.GetType().GetField("_aPrivateField",
        BindingFlags.Instance | BindingFlags.NonPublic);
    privateFiled?.SetValue(personForManipulation, "updated private filed value");
